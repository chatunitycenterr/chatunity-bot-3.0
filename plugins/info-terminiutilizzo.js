...
handler.tags = ['termini'];
handler.command = /^(termini|regole)$/i;

export default handler;

function generateMenuText(prefix, botName, userCount) {
    return `
*_Tutte le informazioni menzionate qui non escludono la Proprietaria del Bot e i Proprietari accreditati per l'uso di chatunity-bot*
